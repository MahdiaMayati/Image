...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-8">تعديل الصورة</h1>
        ...
        <form action="{{ route('photos.update', $photo) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-8">
            @csrf
            @method('PUT')

            <div class="mb-6">
                <p class="text-gray-600 mb-2">الصورة الحالية:</p>
                <img src="{{ asset('storage/' . $photo->path) }}" alt="{{ $photo->filename }}" class="w-full h-64 object-cover rounded-lg mb-4">
            </div>

            <div class="mb-6">
                <label for="image" class="block text-gray-700 font-bold mb-2">صورة جديدة (اختياري)</label>
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center hover:border-blue-500 transition cursor-pointer" id="dropZone">
                    ...
                    >
                    <div id="dropText">
                        <p class="text-gray-600 mb-2">اسحب الصورة الجديدة هنا أو</p>
